...
const ShowUserProfileScreen1 = () => {
  ...
  const IconButtonsTurnBack = () => {
    return (
      <IconButton
        onPress={() => {
          dispatch(SetSendMessageId1(0));
          dispatch(SetSendMessageUsername1(''));
          dispatch(SetSendMessageEmail1(''));
          dispatch(SetSendMessageLanguage1(''));
          dispatch(SetSendMessageGender1(''));
          dispatch(SetSendMessageDate1(''));
          dispatch(SetSendMessageTime1(''));
          if (MyStore.sendMessageIdRedux2 == 0) {
            return navigation.goBack('Profile');
          } else {
            return navigation.navigate('ShowUserProfileScreen2');
          }
        }}
                        ...
                        {MyStore.languageRedux == 'tur' ? (
                          <View style={styles.tweetCardUpRetweet}>
                            <Link
                              onPress={() => {
                                dispatch(
                                  SetSendMessageId2(tweet.retweetUser.id),
                                );
                                dispatch(
                                  SetSendMessageUsername2(
                                    tweet.retweetUser.username,
                                ...
                                dispatch(
                                  SetSendMessageEmail2(tweet.retweetUser.email),
                                );
                                dispatch(
                                  SetSendMessageLanguage2(
                                ...
                                dispatch(
                                  SetSendMessageImagePath2(
                                    tweet.retweetUser.imagePath,
                                  ),
                                );
                                onPressTouch();
                                navigation.navigate('ShowUserProfileScreen2');
                              }}>
                              <Text
                                style={[
                                  styles.text4,
          ...
          <View style={styles.sendMessage}>
            <Button
              ...
              onPress={() => {
                ...
                dispatch(SetSendMessageImagePath3(MyStore.sendMessageImagePathRedux1));
...
export default ShowUserProfileScreen1;
